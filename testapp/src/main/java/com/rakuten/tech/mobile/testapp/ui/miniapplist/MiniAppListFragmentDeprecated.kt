...
class MiniAppListFragmentDeprecated : BaseFragment(), MiniAppListener, OnSearchListener,
    ...
    companion object {
        val TAG = MiniAppListFragmentDeprecated::class.java.canonicalName
        fun newInstance(): MiniAppListFragmentDeprecated = MiniAppListFragmentDeprecated()
    }

    private lateinit var viewModel: MiniAppListViewModel
    private lateinit var binding: MiniAppListFragmentDepricatedBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.mini_app_list_fragment_depricated,
            container,
            false
        )
