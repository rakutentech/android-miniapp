...
### 2.x.x (In progress)
- Added `showCustomPermissionWindow` interface to show a default UI for managing custom permissions. [See here](miniapp/USERGUIDE.md#4-implement-the-miniappmessagebridge).
