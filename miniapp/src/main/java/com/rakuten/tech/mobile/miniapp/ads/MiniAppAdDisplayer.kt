...
interface MiniAppAdDisplayer {
    ...
    /** Load the rewarded ad for version 20.2.0 when it is ready. **/
    fun loadRewardedAdSdk(adUnitId: String, onLoaded: () -> Unit, onFailed: (String) -> Unit)
    ...
    /** Show the rewarded ad for version 20.2.0 when it is already loaded. **/
    fun showRewardedAdSdk(adUnitId: String, onClosed: (reward: Reward?) -> Unit, onFailed: (String) -> Unit)
}
