...
class MiniAppFileChooserDefaultSpec {
    ...
    private val invalidMimeTypes = listOf<String>(".jpg", ".jpeg", ".png", ".gif", ".pdf")
    private val validMimeTypes = listOf<String>("image/jpeg", "image/png", "image/gif", "application/pdf")
